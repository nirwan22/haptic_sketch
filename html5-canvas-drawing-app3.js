...
canvasX = toolWidth+0;
    ...
    canvasHeight = $(this).innerHeight()-0;//-vmin(3.7);

    markerX2=400*scaleFactor;
    col1X = 10*scaleFactorM;
    col2X = 100*scaleFactorM;
    col3X = 190*scaleFactorM;
    col4X = 280*scaleFactorM;
    col5X = 370*scaleFactorM;
    col6X = 460*scaleFactorM;
    ...
    mediumImageWidth = 60*scaleFactor;
...
{
	{
	    ...
	    contextTools.arc(locX, locY, 40, 0, 2 * Math.PI, false);
	    contextTools.closePath();
	    contextTools.fillStyle = contextTools.createPattern(crayonTextureImageScales2,"repeat");;
	    contextTools.fill();	
...
//	contextColors.save();
	    ...
	    //context.strokeRect(5,5, canvasWidth-10, canvasHeight-0);
