...
var canvasWidth = $(this).innerWidth()-toolWidth-10;
...
//	var mouseY = Math.round(e.originalEvent.touches[0].pageY - this.offsetTop);
	...
	if(interfaceType=="canvas"){
		...
		// Mouse down location
		if(mouseY<canvasY) // Top of the drawing area
		{
		    ...
		    else if(mouseX>720*scaleFactorM&&mouseX<1030*scaleFactorM){//col 2
			if(mouseY < yUnit*4){
			    redrawInterface("colorpicker");
			}
			else if(mouseY<yUnit*8){
			    if(mouseX <(755+80)*scaleFactorM){
				curSize = "huge";
			    }else if(mouseX < (755+130)*scaleFactorM){
				curSize = "large";
			    }else if(mouseX < (755+170)*scaleFactorM){
				curSize = "normal";
			    }else if(mouseX < (755+200)*scaleFactorM){
				curSize = "small";						
			    }
...
function addClick(x, y, dragging)
{
    ...
    var size=5;
    if(curSize=="small"){
	size=Math.round(sizeHotspotWidthObject.small/2);
    }
    else if(curSize=="medium"){
	size=Math.round(sizeHotspotWidthObject.medium/2);
    }
    else if(curSize=="large"){
	size=Math.round(sizeHotspotWidthObject.large/2);
    }
    else if(curSize=="huge"){
	size=Math.round(sizeHotspotWidthObject.huge/2);
    }
    if (curTool=="marker"){
	...
	for (let i=x-size2; i<=x+size2;i++){
		...
		if(i>drawingAreaX && j>drawingAreaY){pixelTexture[i][j] = "treeBark1";}
	    }
	}	
    }
	...
	for (let i=x-size; i<=x+size;i++){
		...
		if(i>drawingAreaX && j>drawingAreaY){pixelTexture[i][j] = tex;}
	    }
	}	
    }
...
//	contextColors.save();
	...
	if (orient=="landscape"){
	    ...
	    context.drawImage(logoImage, 0, 0, toolWidth,toolWidth*0.6);
	    
	    if(curTool == "crayon"){
		context.drawImage(crayonOnImage, 40*scaleFactorM, yUnit*3,  160*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticCrayonImage, 40*scaleFactorM, yUnit*4,  185*scaleFactorM,55*scaleFactorM);
		context.drawImage(eraserImage, 40*scaleFactorM, yUnit*5,  150*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticsImage, 40*scaleFactorM, yUnit*5.8,  125*scaleFactorM,108*scaleFactorM);
	    }
	    else if(curTool == "haptic-crayon"){
		context.drawImage(crayonImage, 40*scaleFactorM, yUnit*3,  160*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticCrayonOnImage, 40*scaleFactorM, yUnit*4,  185*scaleFactorM,55*scaleFactorM);
		context.drawImage(eraserImage, 40*scaleFactorM, yUnit*5,  150*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticsImage, 40*scaleFactorM, yUnit*5.8,  125*scaleFactorM,108*scaleFactorM);
	    }
	    else if(curTool == "eraser"){
		context.drawImage(crayonImage, 40*scaleFactorM, yUnit*3,  160*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticCrayonImage, 40*scaleFactorM, yUnit*4,  185*scaleFactorM,55*scaleFactorM);
		context.drawImage(eraserOnImage, 40*scaleFactorM, yUnit*5,  150*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticsImage, 40*scaleFactorM, yUnit*5.8,  125*scaleFactorM,108*scaleFactorM);
	    }
		...
		context.drawImage(hapticCrayonImage, 40*scaleFactorM, yUnit*4,  185*scaleFactorM,55*scaleFactorM);
		context.drawImage(eraserImage, 40*scaleFactorM, yUnit*5,  150*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticsOnImage, 40*scaleFactorM, yUnit*5.8,  125*scaleFactorM,108*scaleFactorM);
	    }	
	    context.drawImage(colorPickerImage, 40*scaleFactorM, yUnit*7.6,  176*scaleFactorM,88*scaleFactorM);
	    ...
	    context.strokeStyle= '#70bc5d';
	    context.fillRect(locX, locY, 88*scaleFactorM,60*scaleFactorM);
	    context.strokeRect(locX, locY, 88*scaleFactorM,60*scaleFactorM);
	    context.strokeRect(locX+70*scaleFactorM, yUnit*7.98, 18*scaleFactorM,0.5*scaleFactorM);
	    context.strokeRect(locX+70*scaleFactorM, yUnit*8.10, 18*scaleFactorM,0.5*scaleFactorM);
	    context.strokeRect(locX+70*scaleFactorM, yUnit*8.22, 18*scaleFactorM,0.5*scaleFactorM);
	    context.strokeRect(locX+70*scaleFactorM, yUnit*8.34, 18*scaleFactorM,0.5*scaleFactorM);
	    context.strokeRect(locX+70*scaleFactorM, yUnit*8.46, 18*scaleFactorM,0.5*scaleFactorM);
	    context.strokeRect(locX+70*scaleFactorM, yUnit*8.58, 18*scaleFactorM,0.5*scaleFactorM);
	    
	    context.fillStyle = '#70bc5d';
	    context.fillRect(10, yUnit*7.4, toolWidth-20,4*scaleFactorM);
	    
	    var fontSize=Math.round(18*scaleFactorM);
	    context.font = "600 "+fontSize+"px Arial";
	    context.fillStyle = '#001935';
	    context.fillText("Brush Size", 50*scaleFactorM, yUnit*10);
	    context.fillText("Texture", 50*scaleFactorM, yUnit*8.45);
	    context.fillText("Picker", 50*scaleFactorM, yUnit*8.65);
	    ...
	    context.beginPath();
	    context.arc(locX,locY,radius,0,2 * Math.PI);
	    context.closePath();
	    context.fill();	
	...
	if(orient=="portrait"){
	    ...
	    context.drawImage(logoImage, 0, 0, toolHeight/0.6,toolHeight);
	    
	    if(curTool == "crayon"){
		context.drawImage(crayonOnImage, 550*scaleFactorM, yUnit*1,  160*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticCrayonImage, 550*scaleFactorM, yUnit*4,  185*scaleFactorM,55*scaleFactorM);
		context.drawImage(eraserImage, 550*scaleFactorM, yUnit*7,  150*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticsImage, 1040*scaleFactorM, yUnit*3,  125*scaleFactorM,108*scaleFactorM);
	    }
	    else if(curTool == "haptic-crayon"){
		context.drawImage(crayonImage, 550*scaleFactorM, yUnit*1,  160*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticCrayonOnImage, 550*scaleFactorM, yUnit*4,  185*scaleFactorM,55*scaleFactorM);
		context.drawImage(eraserImage, 550*scaleFactorM, yUnit*7,  150*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticsImage, 1040*scaleFactorM, yUnit*3,  125*scaleFactorM,108*scaleFactorM);
	    }
	    else if(curTool == "eraser"){
		context.drawImage(crayonImage, 550*scaleFactorM, yUnit*1,  160*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticCrayonImage, 550*scaleFactorM, yUnit*4,  185*scaleFactorM,55*scaleFactorM);
		context.drawImage(eraserOnImage, 550*scaleFactorM, yUnit*7,  150*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticsImage, 1040*scaleFactorM, yUnit*3,  125*scaleFactorM,108*scaleFactorM);
	    }
	    else if(curTool == "haptics"){
		context.drawImage(crayonImage, 550*scaleFactorM, yUnit*1,  160*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticCrayonImage, 550*scaleFactorM, yUnit*4,  185*scaleFactorM,55*scaleFactorM);
		context.drawImage(eraserImage, 550*scaleFactorM, yUnit*7,  150*scaleFactorM,60*scaleFactorM);
		context.drawImage(hapticsOnImage, 1040*scaleFactorM, yUnit*3,  125*scaleFactorM,108*scaleFactorM);
	    }
	    
	    context.drawImage(colorPickerImage, 800*scaleFactorM, yUnit*1,  176*scaleFactorM,88*scaleFactorM);
	    ...
	    context.fillRect(locX, locY, 88*scaleFactorM,60*scaleFactorM);
	    context.strokeRect(locX, locY, 88*scaleFactorM,60*scaleFactorM);
	    context.strokeRect(locX+70*scaleFactorM, yUnit*1.98, 18*scaleFactorM,0.5*scaleFactorM);
	    context.strokeRect(locX+70*scaleFactorM, yUnit*2.30, 18*scaleFactorM,0.5*scaleFactorM);
	    context.strokeRect(locX+70*scaleFactorM, yUnit*2.62, 18*scaleFactorM,0.5*scaleFactorM);
	    context.strokeRect(locX+70*scaleFactorM, yUnit*2.94, 18*scaleFactorM,0.5*scaleFactorM);
	    context.strokeRect(locX+70*scaleFactorM, yUnit*3.36, 18*scaleFactorM,0.5*scaleFactorM);
	    context.strokeRect(locX+70*scaleFactorM, yUnit*3.68, 18*scaleFactorM,0.5*scaleFactorM);
...
//	    context.fillRect(10, yUnit*7.4, toolWidth-20,4*scaleFactorM);
	    ...
	    context.font = "600 "+fontSize+"px Arial";
	    context.fillStyle = '#001935';
	    context.fillText("Brush Size", 800*scaleFactorM, yUnit*6.9);
	    context.fillText("Texture", 800*scaleFactorM, yUnit*3.25);
	    context.fillText("Picker", 800*scaleFactorM, yUnit*3.85)
